...
> Compatibility pin: this fork is built and tested against extension
> `com.dynatrace.extension.da-aws` version recorded in
> [`extension-versions/da-aws.json`](extension-versions/da-aws.json).
> A nightly workflow (`da-aws-schema-watch`) tracks newer versions on a
> reference tenant and opens a Coding-Agent-driven PR when the schema
> changes.
...
- Schema compatibility pin: [`extension-versions/da-aws.json`](extension-versions/da-aws.json)
- Schema-bump automation: [`.github/workflows/da-aws-schema-watch.yml`](.github/workflows/da-aws-schema-watch.yml)
  + [`.github/agents/da-aws-bump/`](.github/agents/da-aws-bump/)
